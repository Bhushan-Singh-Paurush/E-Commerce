export const orderNotification = ({data}:{data:{order_id:string,orderDetailsUrl:string}}) => {
  const html = `
        <!DOCTYPE html>
															...
															<td class="pad"
																...
																<div align="center" class="alignment">
																	<div style="max-width: 248px;"><img alt="Logo"
																			height="auto" src="https://res.cloudinary.com/dgeumzbuo/image/upload/v1756746557/logo-black_paotli.webp"
															...
															<td class="pad"
																...
																<div align="center" class="alignment">
																	<div style="max-width: 13px;"><img alt="Check"
																			height="auto" src="https://res.cloudinary.com/dgeumzbuo/image/upload/v1756746556/check-orange_ydklv3.webp"
																			style="display: block; height: auto; border: 0; width: 100%;"
															...
															<td class="pad">
																<div align="center" class="alignment">
																	<div style="max-width: 130px;"><img
																			...
																			src="https://res.cloudinary.com/dgeumzbuo/image/upload/v1756746557/order-conf-icon_qxjiqh.webp"
																			style="display: block; height: auto; border: 0; width: 100%;"
																		...
																		<tr>
																			<td style="padding:0 0 0 4px;"><a
																					...
																					target="_blank"><img alt="facebook"
																						height="auto"
																						src="https://res.cloudinary.com/dgeumzbuo/image/upload/v1756746556/facebook2x_kenda3.webp"
																			...
																			<td style="padding:0 0 0 4px;"><a
																					...
																					target="_blank"><img alt="twitter"
																						height="auto"
																						src="https://res.cloudinary.com/dgeumzbuo/image/upload/v1756746557/twitter2x_fndfg5.webp"
																						style="display: block; height: auto; border: 0;"
																						title="twitter"
																						width="32" /></a></td>
																			<td style="padding:0 0 0 4px;"><a
																					...
																					target="_blank"><img alt="instagram"
																						height="auto"
																						src="https://res.cloudinary.com/dgeumzbuo/image/upload/v1756746556/instagram2x_rwgt1i.webp"
																						style="display: block; height: auto; border: 0;"
																						title="instagram"
																						width="32" /></a></td>
																		</tr>
