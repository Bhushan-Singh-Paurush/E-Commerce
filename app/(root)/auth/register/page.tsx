     ...
     <Card>
        <CardContent>
          <div className=' flex flex-col gap-1 items-center'>
            ...
            <Form {...form}>
      <form onSubmit={form.handleSubmit(onRegister)} className="w-full flex flex-col gap-4 items-start">
        ...
        />
         ...
         <LoadingBtn className=' w-full hover:cursor-pointer' text='Register' type='submit' disable={loading}/>
       <div className="text-center text-sm w-full">
              
              Already have account?{" "}
              <Link href={WEBSITE_LOGIN} className=" text-purple-500 underline underline-offset-4">
                Login!
              </Link>
       </div>     
      </form>
