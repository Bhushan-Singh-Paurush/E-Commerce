   ...
   <BreadCrumbFunction data={data}/>
      <Card className="mt-5 px-0 pb-0">
        <CardHeader className=" flex w-full  items-center justify-between">
          ...
          <Button>
           <Link href={ADMIN_ADD_CATEGORY} className=" flex gap-2 items-center"><FaPlus/> New Category</Link>
          </Button>
        </CardHeader>
      
      <CardContent className=" px-0 m-0">
          <DataTable queryKey="Category" deleteUrl="/api/category/delete" fetchUrl="/api/category/get-all-category" editUrl={ADMIN_EDIT_CATEGORY}/>
      </CardContent>
